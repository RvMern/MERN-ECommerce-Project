...
const Shipping = () => {
  const navigate = useNavigate();
    ...
    const shippingSubmit = (e) => {
      ...
      dispatch(saveShippingInfo({address,city,pinCode,state,country,phoneNo}));
      navigate("/order/confirm");
    };

  return (
    <>
        <MetaData title="Shipping -- Let Us Bring Your Product To You" />
        ...
        <div className="shippingContainer">
          <div className="shippingBox">
            ...
            <form className='shippingForm' encType='multipart/form-data' onSubmit={shippingSubmit}>
              ...
              <div>
                <PhoneIcon />
                <input type="number" placeholder='Phone No.' required value={phoneNo} size="10" onChange={(e)=>{setPhoneNo(e.target.value)}} />
              </div>
