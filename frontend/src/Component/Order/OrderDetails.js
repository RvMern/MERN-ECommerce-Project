...
const OrderDetails = () => {
  ...
  return (
    <>
        {loading ? <Loader/> : <>
            <MetaData title="Your Placed Order Details" />
            <div className="orderDetailsPage">
                <div className="orderDetailsContainer">
                    ...
                    <div className="orderDetailsContainerBox">
                        ...
                        <div>
                            <p>Address: </p>
                            <span>{order.shippingInfo && `${order.shippingInfo.address}, ${order.shippingInfo.city}, ${order.shippingInfo.state}, ${order.shippingInfo.country},
                    ...
                    <div className="orderDetailsContainerBox">
                        ...
                        <div>
                            <p>Amount: </p>
                            <span>Rs {order.totalPrice && order.totalPrice / 100}</span>
                        </div>
                    </div>
                    ...
                    <div className="orderDetailsCartItemsContainer">
                        {
                            order.orderItems && order.orderItems.map(item=>(
                                <div key={item.product}>
                                    ...
                                    <span>Rs {item.price} * {item.quantity}= <b>Rs {item.price * item.quantity}</b></span>
                                </div>
                            ))
                        }
                    </div>
